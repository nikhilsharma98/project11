...
Route::get('/student_fees/create/{id}', 'StudentFeesController@createStudentFees');
Route::post('/student_fees/storestudentfees', 'StudentFeesController@storeStudentFees');
