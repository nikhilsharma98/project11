...
<div class="col-md-12">
        <h2>Edit Student</h2>
    <form class="form-horizontal" form="id" action="{{ URL::route('student_class_students.update', [$student_class_student->id]) }}" method="POST" enctype="multipart/form-data" novalidate>
        {{ csrf_field() }}
